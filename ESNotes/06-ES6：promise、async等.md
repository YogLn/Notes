...
- 如果请求成功了，请写resolve()，此时，promise的状态会被自动修改为fulfilled。
...
![](C:\Users\linwa\AppData\Roaming\Typora\typora-user-images\image-20200908220701544.png)
...
2、async返回的总是**Promise对象**，可以用then方法进行下一步操作。
